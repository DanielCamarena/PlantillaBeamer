\documentclass[12pt]{beamer} %con pause/animaciones
%\documentclass[12pt,handout]{beamer} %sin pause
%\documentclass[12pt,aspectratio=169]{beamer} %con pause, aspecto panorámico
...
\usepackage{amssymb} %paquete de símbolos
\usepackage{amsthm} %para poner demostración a un teorema

\usepackage{graphicx} % paquete gráfico

\usepackage{natbib}
\bibliographystyle{apalike} %Agregar formato de citación APA6
